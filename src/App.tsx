    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {images.length === 0 ? (
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Formats Multiples</h3>
              ...
              <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Redimensionnement Intelligent</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Traitement par Lots</h3>
                <p className="text-gray-600 text-sm">
          ...
          <div>
            {/* Action Bar */}
            <div className="flex items-center justify-between mb-8 p-4 bg-white rounded-xl shadow-sm border border-gray-200">
